FOLDER CONTAINING USED DATASETS

Although all datasets are available online I prepared this folder with the csv files for each one.
...
Here is where I obtained the datasets:
Iris:
